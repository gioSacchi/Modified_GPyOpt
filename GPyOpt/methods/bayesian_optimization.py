...
from ..core.task.objective import SingleObjective, SeparatedObjective
...
class BayesianOptimization(BO):
    ...
    def __init__(self, f, domain = None, constraints = None, context = None, cost_withGradients = None, model_type = 'GP', X = None, Y = None,
        ...
        if 'acquisition' in self.kwargs:
            if isinstance(kwargs['acquisition'], GPyOpt.acquisitions.AcquisitionBase):
                ...
                # TODO: make sep acquisition function based on outline
            else:
